...
@section('title', 'Master Guru – SIA')

@section('content')
    <div x-data="guruIndex()" class="space-y-6">
        ...
        @php
            ...
            if ($statusKepegawaian) {
                $collection = $collection->filter(function ($row) use ($statusKepegawaian) {
                    return strtolower((string) ($row['status_kepegawaian'] ?? '')) === strtolower($statusKepegawaian);
                })->values();
            }
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm text-slate-500">
                                    Gunakan pencarian dan filter untuk mempersempit data guru.
                                </p>
                            </div>
                        </div>
                            ...
                            <form method="GET" class="flex w-full flex-col gap-3 sm:flex-row lg:w-auto lg:items-center">
                                ...
                                <select name="status_kepegawaian"
                                    ...
                                    @foreach ([
                                        ...
                                        <option value="{{ $kode }}" @selected(request('status_kepegawaian') == $kode)>
                                            {{ $label }}
                                        </option>
                                    @endforeach
                                </select>
        ...
        @forelse($pageItems as $row)
            ...
            <tr
                ...
                <td
                    ...
                    <a href="{{ route('kepsek.sia-master.guru.show', $row['id']) }}"
