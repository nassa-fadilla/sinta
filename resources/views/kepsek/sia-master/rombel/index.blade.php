...
@section('title', 'Master Rombel – SIA')@section('content')
    <div x-data="rombelIndex()" class="space-y-6">
        ...
        @php
            ...
            if ($tingkat) {
                $rows = $rows->filter(function ($r) use ($tingkat) {
                    return strtolower((string) ($r['tingkat'] ?? '')) === strtolower((string) $tingkat);
                })->values();
            }
            ...
            <div class="relative">
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm text-slate-500">
                                    Gunakan pencarian dan filter untuk mempersempit data rombel.
                                </p>
                            </div>
                        </div>
                            ...
                            <form method="GET" x-ref="searchForm" class="w-full lg:flex-1 lg:max-w-3xl">
                                ...
                                <div
                                    ...
                                    <input type="text" name="q" value="{{ request('q') }}"
                                        placeholder="Cari nama rombel / wali kelas..."
                ...
                <div class="overflow-hidden">
                    <div class="overflow-x-auto">
                        <table class="w-full min-w-[1240px] table-auto border-collapse text-sm">
                            <thead class="bg-slate-50">
                                <tr
                                    ...
                                    <th class="px-5 py-4">Nama Rombel</th>
                            ...
                            <tbody class="divide-y divide-slate-100/90 text-slate-700">
                                @forelse($pageItems as $r)
                                    @php
                                        ...
                                        $dotClass = $aktif === 1 ? 'bg-emerald-500' : 'bg-slate-400';
                                    @endphp
                                    ...
                                    <tr
                                        ...
                                        <td class="px-5 py-4">
                                            <span
                                                ...
                                                <span>{{ $aktif === 1 ? 'Aktif' : 'Nonaktif' }}</span>
                                            </span>
                                        </td>
                                        ...
                                        <td
                                            ...
                                            <a href="{{ route('kepsek.sia-master.rombel.show', $r['id']) }}"
                                    ...
                                    <tr>
                                        <td colspan="9" class="px-5 py-14 text-center">
                                            <div class="flex flex-col items-center justify-center gap-3 text-slate-500">
                                                ...
                                                <div>
                                                    <p class="text-sm font-semibold text-slate-700">Tidak ada data rombel.</p>
