    ...
    [
      ...
      'items' => [
        [
          ...
          'route' => 'admin.sia-master.ekskul.index',
          'icon' => 'M12 6v12m6-6H6'
        ],
        [
          'label' => 'Pengumuman',
          'route' => 'admin.pengumuman.index',
          'icon' => 'M3 5h18v14H3z M3 10h18',
          'notifKey' => 'pengumuman'
        ],
      ],
    ],
    [
      ...
      'items' => [
        [
          ...
          'icon' => 'M8 10h8m-8 4h5M4 6h16v12H4z M12 18l4 4 4-4',
          'notifKey' => 'chat'
        ],
        [
          'label' => 'Survei Ortu',
              ...
              @foreach($g['items'] as $it)
                ...
                <li>
                  <a href="{{ $hrefOf($it['route']) }}"
                    ...
                    @if(isset($it['notifKey']))
                      <template x-if="notif['{{ $it['notifKey'] }}'] > 0">
                        <span class="h-2.5 w-2.5 rounded-full bg-red-500 shrink-0 animate-pulse">
                        </span>
                      </template>
                    @endif
        ...
        async loadNotif() {
          try {
            ...
            this.notif = {
              ...
              survei: Number(data.survei || 0),
              pengumuman: Number(data.pengumuman || 0),
            };
